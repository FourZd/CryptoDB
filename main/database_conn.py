...
class DBOrganization():
    ...
    def initialize_db(self):
        ...
        CryptoDB.create_tables([BscContracts], safe = True)
        CryptoDB.close()
    ...
    def default_block(self): #if there's no information in the DB, set a number of the last block
        ...
        try:
            ...
            default_block = ProccessedBlocks.insert(blockchain = 'eth', number=w3.eth.get_block('latest')['number']).execute()
        else:
